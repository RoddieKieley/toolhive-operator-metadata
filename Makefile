...
catalog: bundle ## Generate FBC catalog metadata from bundle
	...
	@echo "  - name: toolhive-operator.v0.6.11" >> catalog/toolhive-operator/catalog.yaml
	@echo "    replaces: toolhive-operator.v0.4.2" >> catalog/toolhive-operator/catalog.yaml
	@echo "" >> catalog/toolhive-operator/catalog.yaml
	@echo "---" >> catalog/toolhive-operator/catalog.yaml
	...
	@echo "schema: olm.bundle" >> catalog/toolhive-operator/catalog.yaml
	@opm render bundle/ -o yaml | sed '1d' | sed '/^image:/d' | sed '/^schema:/d' >> catalog/toolhive-operator/catalog.yaml
